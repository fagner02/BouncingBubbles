...
var playername = ""
var playerscene = preload("res://scenes/oponent.tscn")
...
func _process(_delta):
	...
	var minutes: int = floor(game_timer.time_left/60.0)
	var seconds: int = floor(game_timer.time_left- minutes*60)
...
func _on_button_create_host():
	...
	$"%code".text = "code: "+res+str(add_to_port)
